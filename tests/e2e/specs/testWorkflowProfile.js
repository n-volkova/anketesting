describe('Workflow Profile Test', function() {
    it('Fills and sends Single Profile for Workflow', function() {
        cy.visit('http://localhost:8080/profile?role=workflow')
        ...
        // https://docs.google.com/spreadsheets/d/1jDoPtfN7rKtlNvyMeEtuGRrNC2yaUCUqKqYuHSU5jic/edit#gid=0
    })
})