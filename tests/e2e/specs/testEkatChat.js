describe('Ekat Chat Test', function() {
    it('Fills and sends Ekat Chat', function() {
        cy.visit('http://localhost:8080/ekatchat')
        ...
        // https://docs.google.com/spreadsheets/d/1wthMqeH1A1_rFEnO4nZIWuOti6dlFCcftyCFCjNO93k/edit?usp=sharing
    })
})