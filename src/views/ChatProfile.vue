...
export default {
    ...
    computed: {
        ...
        message() {
            if (this.isEkat) {
                return `<p>Предлагаем тебе заполнить анкету и ответить на наши вопросы, чтобы мы начали знакомство с тобой. Сразу после анкеты тебя ждет тест на грамотность. </p>
                            <div class="divider"></div>
                        <p><strong>Внимание!</strong> Тест ограничен по времени, поэтому если прямо сейчас ты не готов к его прохождению, лучше всего приступить к заполнению анкеты когда будет удобно.</p>`
            } else {
