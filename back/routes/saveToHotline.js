...
const HOT_SHEET = '1DtDIR_WwjIV1uNlGSYehcJ2pZqEKbyxKIyY3QSvyY8s';
                ...
                requests: [{
                    appendCells: {
                        ...
                        rows: [{
                            ...
                            {
                                userEnteredValue: { stringValue: values.startup },
                                userEnteredFormat: {
                                    wrapStrategy: 'CLIP'
                                }
                            },
                            {
                                userEnteredValue: { stringValue: values.rocket },
                                userEnteredFormat: {
                                    wrapStrategy: 'CLIP'
                                }
                            },
